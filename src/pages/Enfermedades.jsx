...
import MapaCalorEnfermedades from '../components/MapaCalorEnfermedades';
    ...
    try {
      ...
      const [palmasRes, registrosRes, statsRes, catalogoRes] =
        await Promise.all([
          ...
          axios.get(`${API_URL}/api/enfermedades`, { headers }),
          axios.get(`${API_URL}/api/enfermedades/stats`, { headers }),
          axios.get(`${API_URL}/api/catalogo/enfermedades`),
        ]);

      setPalmas(palmasRes.data.data || []);
      setRegistros(registrosRes.data.data || []);
      setStats(statsRes.data.data || []);
      setCatalogoEnfermedades(catalogoRes.data.data || []);
    } catch (error) {
  ...
  return (
    <div className="container">
      <header className="header">
        ...
        >
          <h1>🦠 Monitoreo de Enfermedades</h1>
        ...
        <p style={{ color: '#999', fontSize: '12px' }}>
          📚 Catálogo: {catalogoEnfermedades.length} enfermedades disponibles
        </p>
      </header>
      ...
      {viewMode === 'mapa' && <MapaCalorEnfermedades />}
      ...
      {viewMode === 'registros' && (
        ...
        >
          ...
          >
            📋 Registros de Enfermedades ({registros.length})
          </div>
          <div
                  ...
                  registros.map((r) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td style={{ padding: '12px' }}>{r.enfermedad}</td>
